...
async function cargarPedidos() {
    try {
        ...
        $("#btnEnPreparacion").click(function () {
            window.location.href = "bar.php?Vista=EN_PREPARACION";
        });
        $("#btnListoParaServir").click(function () {
            window.location.href = "bar.php?Vista=LISTO_PARA_SERVIR";
        });
        $("#btnServido").click(function () {
            window.location.href = "bar.php?Vista=SERVIDO";
        });
        ...
        let pedidos = await obtenerListaPedidos(2, vista);
        ...
        for (let index = 0; index < pedidos.length; index++) {
            ...
            let detallePlatos = await obtenerListaDetallePedidos(pedido.id, 2, vista);
        ...
        <div class="card ${BordeSegunEstado(estadoPedido)} mb-3 shadow-sm">
            <div class="card-header ${fondoSegunEstado(estadoPedido)} text-white">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                    <h5 class="mb-0"><strong>Mesa #${MesaNumero}</strong></h5>
