...
$query = mysqli_query($conexion, "SELECT * FROM repo_financiero LIMIT $inicio, $registros_por_pagina");
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" placeholder="Ingrese inventario final" class="form-control" name="inventario_final" id="inventario_final" value="0">
                        </div>
                    </div>
                </div>
    ...
    <div class="card shadow-lg">
    <div class="card" style="max-height: 800px ; text-align: center;">
